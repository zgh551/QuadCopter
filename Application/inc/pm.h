...
#define PM_GPIO_SYSOFF_PERIF    RCC_APB2Periph_GPIOB
#define PM_GPIO_SYSOFF_PORT     GPIOB
#define PM_GPIO_SYSOFF          GPIO_Pin_14

#define PM_GPIO_EN1_PERIF       RCC_APB2Periph_GPIOC
#define PM_GPIO_EN1_PORT        GPIOC
#define PM_GPIO_EN1             GPIO_Pin_7

#define PM_GPIO_EN2_PERIF       RCC_APB2Periph_GPIOC
#define PM_GPIO_EN2_PORT        GPIOC
#define PM_GPIO_EN2             GPIO_Pin_6

#define PM_GPIO_IN_CHG_PERIF    RCC_APB2Periph_GPIOC
#define PM_GPIO_IN_CHG_PORT     GPIOC
#define PM_GPIO_IN_CHG          GPIO_Pin_9

#define PM_GPIO_IN_PGOOD_PERIF  RCC_APB2Periph_GPIOC
#define PM_GPIO_IN_PGOOD_PORT   GPIOC
#define PM_GPIO_IN_PGOOD        GPIO_Pin_8

// Power managment pins
#define PM_GPIO_BAT_PERIF       RCC_APB2Periph_GPIOC
#define PM_GPIO_BAT_PORT        GPIOC
#define PM_GPIO_BAT             GPIO_Pin_5

#define PM_BAT_CRITICAL_LOW_VOLTAGE   2.9
#define PM_BAT_CRITICAL_LOW_TIMEOUT   M2T(1000 * 2) // 5 sec
#define PM_BAT_LOW_VOLTAGE            3.0
#define PM_BAT_LOW_TIMEOUT            M2T(1000 * 2) // 5 sec
