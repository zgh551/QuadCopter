 ...
 */
#ifndef __STM32_QDCPT_ADC_H_
#define __STM32_QDCPT_ADC_H_
...
typedef struct AdcPairstruct  //__attribute__((packed))
{
  uint16_t vref;
  uint16_t val;
} AdcPair;

typedef struct AdcGroupstruct //__attribute__((packed))
{
  AdcPair vbat;
} AdcGroup;
